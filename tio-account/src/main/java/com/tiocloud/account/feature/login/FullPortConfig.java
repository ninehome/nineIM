                    ...
                    switch (code) {
                        ...
                        case UMResultCode.CODE_ERROR_USER_LOGIN_BTN:
                            if (!jsonObj.getBoolean("isChecked")) {
                                Toast.makeText(mContext, mContext.getString(R.string.agree_protocal_login),
...
//                        mActivity.startActivityForResult(pIntent, 1002);
        ...
        mAuthHelper.setAuthUIConfig(new UMAuthUIConfig.Builder()
                .setAppPrivacyOne(mContext.getString(R.string.privacy_protocal), "https://test.h5.app.tbmao.com/user")
