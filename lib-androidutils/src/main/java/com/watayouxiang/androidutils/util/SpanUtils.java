...
String msg = "hello ";
SpanUtils builder = SpanUtils.getBuilder(msg)
                            .append("SpannableStringUtil")
...
public class SpanUtils {
    ...
    public static class Builder {
         ...
         *
         * @param flag <ul>
         *             <li>{@link Spanned#SPAN_INCLUSIVE_EXCLUSIVE}</li> 包前不包后
         *             <li>{@link Spanned#SPAN_INCLUSIVE_INCLUSIVE}</li> 包前包后
         *             <li>{@link Spanned#SPAN_EXCLUSIVE_EXCLUSIVE}</li> 不包前不包后
         *             <li>{@link Spanned#SPAN_EXCLUSIVE_INCLUSIVE}</li> 不包前包后
         *             </ul>
         * @return {@link Builder}
         */
         ...
         * @return {@link Builder}
         */
        public Builder setTexSize(int textSize) {
         ...
         * 设置图片
         * 注意：
         * 1. 如果图片显示不出来，查看是否漏了Drawable.setBounds(int left, int top, int right, int bottom)
         * 2. 该图片显示方式是居中显示
         *
         * @param drawable 图片资源
         * @return {@link Builder}
        ...
        private void setSpan() {
            ...
            if (textSize != null) {
                mBuilder.setSpan(new AbsoluteSizeSpan(textSize), start, end, flag);
                textSize = null;
            }
            if (isSuperscript) {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    ...
                    mBuilder.setSpan(new CenterVerticalImageSpan(drawable), start, end, flag);
                    drawable = null;
    ...
    private static class CenterVerticalImageSpan extends ImageSpan {
        ...
        private CenterVerticalImageSpan(Drawable drawable) {
            super(drawable);
        }
