...
public abstract class BaseFetchLoadAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> implements IRecyclerView {
    ...
    private LoadMoreView mFetchMoreView = new MsgFetchLoadMoreView();

    public boolean isMultiChoose;

    public SparseBooleanArray selectedChecbox = new SparseBooleanArray();
    ...
    private LoadMoreView mLoadMoreView = new MsgFetchLoadMoreView();
