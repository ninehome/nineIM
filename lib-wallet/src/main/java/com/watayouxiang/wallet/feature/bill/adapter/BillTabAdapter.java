package com.watayouxiang.wallet.feature.bill.adapter;
 ...
 * </pre>
 */
public class BillTabAdapter extends TaoTabAdapter {
    public BillTabAdapter(@NonNull RecyclerView recyclerView) {
        super(recyclerView);
    }

    @Override
    protected int getItemViewLayoutId() {
        return R.layout.wallet_bill_tab_item;
    }
    ...
    protected void convert(@NonNull TaoViewHolder holder, int position) {
        ...
        tv_txt.setTypeface(select ? Typeface.defaultFromStyle(Typeface.BOLD) : Typeface.defaultFromStyle(Typeface.NORMAL));
//        tv_txt.setTextColor(select ? Color.parseColor("#FF4C94FF") : Color.parseColor("#FF888888"));
