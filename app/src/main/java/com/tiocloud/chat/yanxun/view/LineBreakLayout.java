...
import com.tiocloud.chat.widget.popup.EasyPopup;
import com.tiocloud.chat.widget.popup.XGravity;
import com.tiocloud.chat.widget.popup.YGravity;
...
public class LineBreakLayout extends ViewGroup {
     ...
     * @param add 是否追加
     */
    public void setLables(List<Label> lables, boolean add){
        if(this.lables == null){
        ...
        if(lables!=null && lables.size()>0){
            ...
            for (final Label lable : lables) {
                //获取标签布局
                final View view = inflater.inflate(R.layout.item_lable, null);
                View deleteDot = view.findViewById(R.id.iv_delete_label);
                TextView tv = view.findViewById(R.id.textview);
                tv.setText(lable.getGroupname()+"("+lable.getFriendList().size()+")");
                tv.setTag(lable);
                ...
                tv.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (onItemClickListener != null){
                            onItemClickListener.back((Label) v.getTag());
                        }
...
//                        deleteDot.setVisibility(VISIBLE);
                        deleteDot.setOnClickListener(new OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                if (onItemDeleteListener != null){
                                    onItemDeleteListener.back((Label) v.getTag());
                                }
                            }
                        });
                        return true;
    ...
    public void showDeletePopup(View tv){
        mCirclePop = EasyPopup.create()
                .setContentView(context, R.layout.popup_delete)
                .setAnimationStyle(R.style.LeftBottomPopAnim)
                //是否允许点击PopupWindow之外的地方消失
                .setFocusAndOutsideEnable(true)
                .apply();

        mCirclePop.showAtAnchorView(tv,YGravity.BELOW,XGravity.CENTER);
        TextView tv_delete = mCirclePop.findViewById(R.id.tv_delete);
