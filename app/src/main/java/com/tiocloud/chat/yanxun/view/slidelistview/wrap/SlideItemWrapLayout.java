package com.tiocloud.chat.yanxun.view.slidelistview.wrap;
...
public class SlideItemWrapLayout extends RelativeLayout {
    ...
    /**
     * @param context
     * @param slideLeftAction  Decided where the left view placed.<br/>
     ...
     * @param slideRightAction Decided where the right view placed.<br/>
     ...
     * @param frontViewId      front view layout id. Must be an effective
     * @param leftBackViewId   left back view layout id.if leftBackViewId ==0,there is no
     *                         left back view,and the slideLeftAction will be ignored
     * @param rightBackViewId  right back view layout id.if rightBackViewId ==0,there is no
