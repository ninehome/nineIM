...
import com.tiocloud.chat.yanxun.map.LocationSp;

public class BdLocationHelper {
    public static final String ACTION_LOCATION_UPDATE = BuildConfig.APPLICATION_ID + ".action.location_update";
    ...
    private BDLocationListener mMyLocationListener = new BDLocationListener() {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            if (TioConfig.IS_DEVELOPE) {
                Log.d("zlb", "百度定位信息  mLongitude:" + mLongitude + "  mLatitude:" + mLatitude + "  mAddressDetail:" + mAddress);
            }
            mLocationClient.stop();
