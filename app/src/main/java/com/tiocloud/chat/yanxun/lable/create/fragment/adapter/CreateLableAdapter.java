...
import com.tiocloud.chat.yanxun.lable.create.fragment.adapter.model.SectionModel;
 ...
 * desc :
 */
public class CreateLableAdapter extends BaseMultiItemQuickAdapter<MultiModel, BaseViewHolder> implements BaseQuickAdapter.OnItemClickListener {
    ...
    public void setCheckedIds(LinkedList<String> checkedIds){
...
//        if(getData().get(helper.getAdapterPosition()+1).type == MultiType.SECTION){
//            v_divider.setVisibility(View.GONE);
//            v_divider1.setVisibility(View.VISIBLE);
//        }else {
...
//        }
        ...
        tv_subtitle.setText(KeywordUtil.matcherSearchTitle(
                Color.parseColor("#FF4C94E8"),
                TextUtils.isEmpty(item.remarkname) ? "" : (mContext.getString(R.string.nick)+": " + item.nick),
                keyWord));
