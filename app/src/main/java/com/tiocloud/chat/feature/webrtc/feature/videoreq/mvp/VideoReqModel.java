package com.tiocloud.chat.feature.webrtc.feature.videoreq.mvp;
 ...
 * </pre>
 */
public class VideoReqModel extends VideoReqContract.Model {
    @Override
    public void reqUserInfo(int uid, VideoReqContract.View view) {
        if (uid == -1) {
