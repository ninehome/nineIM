 ...
 * desc :
 */
public class P2PMsg extends TioMsg {
    private final WxFriendChatNtf item;
    private final String currUid;
    private final String currNick;

    public P2PMsg(WxFriendChatNtf chatNtf, String currUid, String currNick) {
        this.item = chatNtf;
